		...
		<div id='content' class='row-fluid'>
			<div class='span2 sidebar'>
				<ul class="nav nav-tabs nav-stacked">
					...
					<li style="background-color: #EEEEEE;"><a href="/faqintroduce.action">FAQ ＆
							문의사항</a></li>
				</ul>
			</div>
			<!-- 메인 메뉴 -->
			<div class='span8 main'>
				...
				<table class="table table-bordered">
					<tr style="background-color: skyblue;">
						<th colspan="3">${faqList.title }</th>
					</tr>
					<tr>
						<td>${faqList.adminId }</td>
						<td>${faqList.faqDate }</td>
						<td>신고하기 : <a><span
								class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span></a>
							</td>
					</tr>
					<tr>
						<td colspan="3">${faqList.content }</td>
					</tr>
				</table>

		
				<form action="/faqintroduce.action">
