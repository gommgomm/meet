...
<script type="text/javascript">
   ...
   function googleMap()
   {
      //loc_geolat, loc_geolng
      var a = "${eventInfo.loc_geolat}";
      var b = "${eventInfo.loc_geolng}";
...
<div class="container"> 
   ...
   <p id="eventLocation" style="float: left; font-size: 18px; overflow: hidden; text-overflow: ellipsis; width: 400px; text-align: left; padding-left: 1%; font-weight: bolder;">
