...
public class ImgController
{
	...
	@RequestMapping(value = "/sample/image/generalUpload.action")
	public String generalUpload(HttpServletRequest req, HttpSession session, Image image) throws Exception
	{
	...
	// HTML 5 upload
	@RequestMapping(value = "/sample/image/html5Upload.action")
	public void html5Upload(HttpServletRequest req, HttpServletResponse resp, HttpSession session) throws Exception
	{
		String cp = req.getContextPath();
