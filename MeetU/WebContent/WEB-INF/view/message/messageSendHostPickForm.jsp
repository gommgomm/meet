...
<body>
	...
	<div class="container"
		...
		<div class="form-area">
			<form role="form">
				<br style="clear: both"> <a href="messageMyreceive.jsp"><button
						type="button" class="btn btn-info">받은 쪽지</button></a> <a
					href="messageMysent.jsp"><button type="button"
				...
				<div class="form-group">
					...
					<span class="help-block">최대 140까지만 허용됩니다.</span> <a
						href="messageMysent.jsp"><button type="button" id="submit"
