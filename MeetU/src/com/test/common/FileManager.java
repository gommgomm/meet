...
public class FileManager
{
	...
	// target : 경로, base64 : 이미지 base64 인코딩 코드 
	public String ChangeImg(String base64, String target)
	{
		// 타입 가져오기
		...
		String name = String.format("%1$tY%1$tm%1$td%1$tH%1$tM%1$tS", Calendar.getInstance())+System.nanoTime()+".";
		...
		try {
			...
			ImageIO.write(bufImg, type, new File(target));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			
			return "/images/meetU.png";
		}
