    ...
    function html5Upload() {	
    	...
    	sUploadURL=getContextPath()+'/image/html5Upload.action'; 
    	/*getContextPath()+'/images.action'; 	//upload URL
*/    	
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function getContextPath()
	{
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : getContextPath()+'/image/generalUpload.action',
 			/*sUrl  : getContextPath()+'/image.action',	//샘플 URL입니다.
*/ 	        sCallback : getContextPath()+'/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
